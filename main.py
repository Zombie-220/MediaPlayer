...
class MainWindow(QMainWindow):
    def __init__(self, title: str):
        ...
        self.__mediaPlayer.positionChanged.connect(self.durationChanged)
        ...
        self.__sliderDuration.sliderReleased.connect(self.rewind)
    ...
    def durationChanged(self, d: int) -> None:
        m = d // 1000 // 60
        s = d // 1000 % 60
    ...
    def changeMedia(self, musicID: int) -> None:
        ...
        playbackState = self.__mediaPlayer.playbackState()
        self.__mediaPlayer.stop()
        time.sleep(0.5)
...
if __name__ == '__main__':
    ...
    sys.exit(app.exec())
        ...
        # m = d // 1000 // 60
        # s = d // 1000 % 60
        # self.length.setText(f'Length - {m:>1}:{s:0>2}') 